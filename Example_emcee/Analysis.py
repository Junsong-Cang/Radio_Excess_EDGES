...
# ---- Initialise ----
ChainFile_Swap = "data/Chains_Swap.h5"
ConvergeFile_Swap = "data/Status_Swap.h5"
...
fig.savefig('results/Convergence.png',bbox_inches='tight',dpi=100)
plt.close()
...
fig.savefig("results/Triangular_Stat.png")

os.system('open results/Triangular_Stat.png')
os.system('open results/Convergence.png')
